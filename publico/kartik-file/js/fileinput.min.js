    ...
    t = {
        ...
        _initPreviewTemplates: function () {
            ...
            e.each(r.previewContentTemplates, function (e, r) {
                t.isEmpty(a.previewTemplates[e]) && (i = n.tagBefore2, "generic" !== e && "image" !== e && "html" !== e && "text" !== e || (i = n.tagBefore1), a._isPdfRendered() && (i = i.replace("kv-file-content", "kv-file-content kv-pdf-rendered")), a.previewTemplates[e] = i + r + o)
            })
        },
        ...
        _setThumbStatus: function (e, t) {
            ...
            if (i.showPreview) {
                ...
                e.removeClass("file-preview-success file-preview-error file-preview-loading"), "Success" === t && e.find(".file-drag-handle").remove(), o.html(l[a]), o.attr("title", l[r]),
        ...
        readFiles: function (i) {
            ...
            r.loadedImages = [], r.totalImagesCount = 0, e.each(i, function (e, t) {
                ...
                var T, E, S, k, F, P, I, A, D, z, $, j, U = v + x,
                    ...
                    L = m.image,
                    Z = m.html,
                    M = R && R.name ? r.slug(R.name) : "",
                    N = (R && R.size || 0) / 1e3,
                    H = "",
                    V = R ? t.objUrl.createObjectURL(R) : null,
                    W = 0,
                    q = "",
                    K = 0,
                    G = function () {
                ...
                if (R) {
                    ...
                    if (0 === M.length) return S = r.msgInvalidFileName.replace("{name}", t.htmlEncode(R.name)), void y(S, R, B, x);
                    ...
                    o.length && void 0 !== FileReader ? (D = O(R.type, M), z = Z(R.type, M), $ = L(R.type, M), d.html(c.replace("{index}", x + 1).replace("{files}", f)), s.addClass("file-thumb-loading"), l.onerror = function (e) {
                        r._errorHandler(e, M)
                    }, l.onload = function (i) {
                        var a, n, o, s, d, c, p = [],
                            u = function (e) {
                                ...
                                t.onerror = function (e) {
                                    ...
                                    r._previewFile(x, R, e, B, V, n), r._initFileActions(), G()
                        ...
                        if (n = {
                            ...
                            if (a = p.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(l.result), c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, R.type)), n = {
                                    name: M,
                                    type: c
                                }, D = O(c, ""), z = Z(c, ""), $ = L(c, ""), j = D || z, j || $) return void u(j)
                        }
                        r._previewFile(x, R, i, B, V, n), r._initFileActions(), G()
