...
$('#rol_grado').change(function (){           
    ...
    $.post( 'comboCursoGradoProf',{grado:grado},function (data){
...
$('#rol_seccion').change(function (){
    ...
    var grado=$('#rol_grado').val();	
            ...
            $("#rol_nota").html("");
                ...
                $.post( 'comboConfiguracion',{grado:grado,seccion:seccion},function (data){
                    $('#rol_nota').html(data);
                                $("#bandejaNotas").html("Ingrese el Curso...");                          
                    } );                  
            }
    ...
    $('#rol_nota').change(function (){
            ...
            $.ajax({
                ...
                data:{nota:nota,curso:curso,grado:grado},
