...
$(document).ready(function(){
	$('#rol_ano').change(function (){
		...
		$.post( 'comboCursoRecord',{ano:ano},function (data){
			$('#rol_curso').html(data);
                        $("#bandejaNotasRecord").html("Ingrese el Curso...");                        
			});
                }
		...
		var curso=$(this).val(); 
                ...
                $("#bandejaNotasRecord").html("Ingrese el Curso...");    
                    ...
                    $("#bandejaNotasRecord").html(' <center> <i id="estadistica-load" class="fa fa-circle-o-notch fa-spin" style="font-size:24px;color:#ec7063"></i></center>'); 
                    
		$.post( 'bandejaNotaRecod',{curso:curso,ano:ano},function (data){
