...
$(document).ready(function(){
	$('#rol_ano').change(function (){
		var ano=$(this).val();	                
                if(ano==='Seleccione'){
                 ...
                 $.post( 'comboAnoDir',{ano:ano},function (data){$('#rol_grado').html(data);});
                }        
	});
	$('#rol_grado').change(function (){
		...
		$.post( 'comboGradoDir',{ano:ano},function (data){
		...
		$.post( 'comboBandeGen',{ano:ano,grado:grado,bimestre:bimestre},function (data){
