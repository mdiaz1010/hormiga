...
//
    ...
    $('#ContainerProd').dialog({ draggable: false });
    $('#ContainerProd').dialog({ resizable: false });
    ...
    $('#ContainerGrado').dialog({ draggable: false });
    $('#ContainerGrado').dialog({ resizable: false });    
    ...
    $('#ContainerSeccion').dialog({ draggable: false });
    $('#ContainerSeccion').dialog({ resizable: false });      
    ...
    $('#ContainerBimestre').dialog({ draggable: false });
    $('#ContainerBimestre').dialog({ resizable: false });     
    ...
    $('#ContainerNotas').dialog({ draggable: false });
    $('#ContainerNotas').dialog({ resizable: false });     
    ...
    $('#ContainerCurso').dialog({ draggable: false });
    $('#ContainerCurso').dialog({ resizable: false });       
...
if(grado==='')          {$('#result_errors').html("<font color='red'>Seleccionar GRADO   (*) Obligatorio</font>");}
else if(seccion==='')   {$('#result_errors').html("<font color='red'>Seleccionar SECCION (*) Obligatorio</font>");}
else if(curso==='')     {$('#result_errors').html("<font color='red'>Seleccionar CURSO   (*) Obligatorio</font>");}
else if(profesor==='')  {$('#result_errors').html("<font color='red'>Seleccionar PROFESOR(*) Obligatorio</font>");}
else if(horario.length==='')  {$('#result_errors').html("<font color='red'>ESCOGER HORARIOS(*) Obligatorio</font>");}
else if(dias.length==='')  {$('#result_errors').html("<font color='red'>ESCOGER DIAS(*) Obligatorio</font>");}
else{
        $.ajax({
            type: 'POST',
