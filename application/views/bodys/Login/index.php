  ...
  <div class="col-md-6 col-sm-6 col-xs-12">
    <div class="x_panel">
      ...
      <div id="estadistica" class="x_content">
        <center>
          <i id="estadistica-load" class="fa fa-circle-o-notch fa-spin" style="font-size:24px;color:#ec7063"></i>
        </center>
    ...
    <div class="x_panel">
      ...
      <div class="x_content">
        <div id="merito" class="table-responsive">
          <center>
            <strong>
              <p style="color:#ec7063">Procesando la informacion </p>
            </strong>
            <i id="merito-load" class="fa fa-circle-o-notch fa-spin" style="font-size:24px;color:#ec7063"></i>
          </center>
        </div>
      </div>
    </div>
