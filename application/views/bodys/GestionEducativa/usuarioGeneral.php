                ...
                <form method="post" name="crearusuario" id="crearusuario"  data-parsley-validate autocomplete="off">
                    <div class="col-xs-10">
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-12 col-sm-12 col-xs-12">
                                Dni:
                                <input name="documento" id="documento" placeholder="documento" type="number" class="form-control"  value="<?=$bodyData->results['docume']?>" required>
                            </label>
                            <label class="control-label col-md-12 col-sm-12 col-xs-12">
                                email:
...
<script type="text/javascript">
    ...
    $("#crearusuario").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: 'POST',
                url: url+"GestionEducativa/editarInfo",
                data: formdata,
                processData: false,
                contentType: false,
                success: function (data) {
                    if(data=='n')
                    {
                                    $.notify("Error, está intentando subir un archivo con extensión no permitida", {
                                        position: 'b l',
                                        className:'error',
