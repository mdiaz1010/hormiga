...
<div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><span class="fa fa-search"></span> INTRANET EDUCATIVO - Carga Individual </h2>
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    Nombre:
                    <input name="nombre"  id="nombre" placeholder="Nombres"  class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required >
                </label>
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    Apellido Paterno:
                    <input name="apepat"  id="apepat" placeholder="Apellido paterno"  class="form-control"  style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required >
                </label>                    
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    Apellido Materno:
                    <input name="apemat"  id="apemat" placeholder="Apellido materno"  class="form-control"  style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" required >
                </label>                
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    Rol:
                ...
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                    Direccion: 
                    <input name="direccion" id="direccion" placeholder="Direccion " type="text " class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" >
                </label>                        
                <div class="col-xs-6 col-md-3">
                    <textarea class="form-control  col-md-6" name="descripcion" id="descripcion" type="text" placeholder="Breve descripcion..." rows="2" id="comment"></textarea>
                </div>    
                </div>                                                                      
                ...
                <label class="control-label col-md-6 col-sm-6 col-xs-12">
                    <button type="button" name="btnregistrar" id="btnregistrar"  value="Registrar" class="form-control btn-success">
                        <strong>REGISTRAR</strong> <span class="glyphicon glyphicon-ok"></span>
                    </button>
                </label>                
                <label class="control-label col-md-3 col-sm-3 col-xs-12">
                <p id="result_error"></p>
            ...
            <div class="col-xs-12"><?=($this->session->flashdata('flashdata_respuesta')!=null)? '<h4 class="text-danger" >'.$this->session->flashdata('flashdata_respuesta')."</h4>":'' ?></div>                             
                  </div>
                </div>
              </div>  
    <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><span class="fa fa-search"></span> INTRANET EDUCATIVO - Carga Masiva profesores</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
                  ...
                  <div class="x_content">
                      <label class="control-label col-md-6 col-sm-6 col-xs-12">Cargar Archivo:<input type="file" name="archiMas" id="archiMas"></label><br>      
                      <label class="control-label col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><span class="fa fa-search"></span> INTRANET EDUCATIVO - Carga Masiva alumno</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
                  ...
                  <div class="x_content">
                      <label class="control-label col-md-6 col-sm-6 col-xs-12">Cargar Archivo:<input type="file" name="archiMasAlu" id="archiMasAlu"></label><br>      
                      <label class="control-label col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2></span> Historial de Usuario</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      <li><a class="close-link"><i class="fa fa-close"></i></a>
