                ...
                <div class="col-xs-10">
                    <form method="post" name="crearusuario" id="crearusuario">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">
                                Fecha de Nacimiento:
                                <input readonly name="fecha" id="fecha" type="date" placeholder="fecha" class="form-control" required value="<?=$bodyData->results1['fecha']?>">
                            </label>
                            <label class="control-label col-md-9 col-sm-9 col-xs-12">
                                Direccion:
                                <textarea name="direccion" id="direccion" placeholder="Direccion " class="form-control" style="text-transform:uppercase;"
                                 readonly   onkeyup="javascript:this.value=this.value.toUpperCase();" rows="1"><?=$bodyData->results1['direcc']?></textarea>
                            </label>
                        </div>
