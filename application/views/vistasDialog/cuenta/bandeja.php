...
<script type="text/javascript">		                
                $("#DIVEDITARCUENTA").dialog({
                    ...
                    buttons: {                                                
                        ...
                        var emails = $("#txtemailscuenta").val();
                                if(nombre===''){ $('#result_nombre').html("<font color='red'>Campo Nombre (*) Obligatorio</font>");               return true;}else{$('#result_nombre').html("");}
                                if(apepat===''){ $('#result_apepat').html("<font color='red'>Campo  (*) Obligatorio</font>");                     return true;}else{$('#result_apepat').html("");}
                                if(apemat===''){ $('#result_apemat').html("<font color='red'>Campo  (*) Obligatorio</font>");                     return true;}else{$('#result_apemat').html("");}                        
                                if(usuari===''){ $('#result_usuario').html("<font color='red'>Campo (*) Obligatorio</font>");                     return true;}else{$('#result_usuario').html("");}                       
                                if(claves===''){ $('#result_clave').html("<font color='red'>Campo   (*) Obligatorio</font>");                     return true;}else{$('#result_clave').html("");}                       
                                if(telefo===''){ $('#result_telefono').html("<font color='red'>Campo(*) Obligatorio</font>");                     return true;}else{$('#result_telefono').html("");}                       
                                if(docume===''){ $('#result_dni').html("<font color='red'>Campo     (*) Obligatorio</font>");                     return true;}else{$('#result_dni').html("");} 
                                if(emails===''){ $('#result_email').html("<font color='red'>Campo   (*) Obligatorio</font>");                     return true;}else{$('#result_email').html("");}   
                ...
                $("#DIVEDITARCUENTA").dialog({ draggable: true });
                $("#DIVEDITARCUENTA").dialog({ resizable: true });                                 
...
<script>$("#dataTables-usuario").dataTable();</script>