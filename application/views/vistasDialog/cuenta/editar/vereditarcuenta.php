        ...
        <form action="" method="post" name="edicioncuenta" id="edicioncuenta">
            <div class="form-group">
                <label class="control-label col-md-12 col-sm-12 col-xs-12">
                    ...
                    <input type="text" class="form-control" id='txtnombrecuenta' style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"
                        name="txtnombrecuenta" value="<?php echo $bodyData->datoscuenta[0]->NOMBRE; ?>">
                </label>
                <label class="control-label col-md-12 col-sm-12 col-xs-12">
                    Apellido Paterno:
                ...
                <label class="control-label col-md-12 col-sm-12 col-xs-12">
                    Apellido Materno:
                    <input type="text" class="form-control" id='txtapematcuenta' style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"
                        name="txtapematcuenta" size="35" value="<?php echo $bodyData->datoscuenta[0]->APEMAT; ?>">
                </label>
                <label class="control-label col-md-12 col-sm-12 col-xs-12">
                    Rol:
                        ...
                        <?php
                                    foreach ($bodyData->roles as $rolesTemp) {
                                        if ($rolesTemp->id==$bodyData->datoscuenta[0]->USUARR) {
                                            $selected="selected"; ?>
                            <option name='opciones' selected value="<?=$rolesTemp->id?>">
                                <?=$rolesTemp->nombre?>
                            </option>
                            <?php
                                        } else {
            ...
            <div class="form-group">
                ...
                <label class="control-label col-md-12 col-sm-12 col-xs-12">
                    ...
                    <textarea class="form-control  col-lg-3" name="txtdirecccuenta" id="txtdirecccuenta" type="text" placeholder="Breve descripcion..."
                        rows="2" id="comment">
                        <?php echo $bodyData->datoscuenta[0]->DIRECC; ?>
                    </textarea>
                </label>
            </div>
        </form>
