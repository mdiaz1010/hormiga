<div class="row">
      ...
      <div class="x_content">
        ...
        <form id="configuracion_nota" name="configuracion_nota" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Abreviacion
              <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input minlength="1" maxlength='3' type="text" id="abreviacion" name="abreviacion" required="required" class="form-control col-md-7 col-xs-12"
                placeholder="Ejemplo: PC1">
            </div>
          </div>
          ...
          <div class="form-group">
            <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Peso
              <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input minlength="1" maxlength='3' id="peso" class="input-number form-control col-md-7 col-xs-12" type="text" name="peso"
  ...
  <div class="form-group">
    ...
    <div class="col-md-3 col-sm-3 col-xs-3 col-md-offset-3">
      <button class="btn btn-danger" id="btnRegistroFin" name="btnRegistroFin" type="reset">Finalizar
