...
<link rel="stylesheet" href="<?=base_url('publico/kartik-file/css/fileinput.min.css')?>" />
    ...
    <link href="<?= base_url('publico/vendors/google-code-prettify/bin/prettify.min.css')?>" rel="stylesheet">
        <script src="<?= base_url('publico/vendors/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js')?>"></script>
        ...
        <label class="control-label " for="first-name">Descripcion:
            <span class="required">*</span>
                 ...
                 <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#editor-one">
                  ...
                  <textarea name="editor-one" id="editor-one" class="editor-wrapper" maxlength="220" style="display:none;"></textarea>
...
<script src="<?= base_url('publico/vendors/jquery.hotkeys/jquery.hotkeys.js')?>"></script>
<script src="<?= base_url('publico/build/js/custom.min.js')?>"></script>
<script>
