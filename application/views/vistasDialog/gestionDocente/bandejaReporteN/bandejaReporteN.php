    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6   col-md-6"> 
            <div class="panel panel-danger">            
                <div class=" panel-heading">
                    <h3 class=" "><i class="fa fa-bar-chart-o"></i> Estadística Notas: </h3> 
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="list-group">
                            ...
                            <div class="list-group-item">
                                ...
                                <a href="<?=  base_url("GestionDocente/comboBandeNotReportG1/".$bodyData->datos['id_grado'].'/'.$bodyData->datos['id_seccion'].'/'.$bodyData->datos['id_curso'].'/'.$bodyData->datos['id_bimestre'])?>" class="detalle"  target="_blank"   >Ver detalles <i class="fa fa-arrow-circle-right"></i></a>
                            </div> 
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <div class="panel panel-success">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-edit"></i>Orden de merito </h3>
              </div>
              <div class="panel-body">
                <div class="table-responsive">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    <tbody>  
                        ...
                        <tr>
                            <td><center><strong><?=$p?></strong></center></td>
                            <td><?=$bodyData->alumno[$merito->id_alumno]?></td>
                            <td><center><strong><?=$merito->nota?></strong></center></td>
                        </tr>
                        <?php  $p++; endforeach;?>
                    </tbody>
            ...
            <div class="panel panel-success">
              <div class="panel-heading">
                    <h3 class="panel-title"><i class="fa fa-check"></i>Leyenda</h3>
              </div>         
                <table  class="table table-bordered table-hover table-striped tablesorter">
                    <tr>    
