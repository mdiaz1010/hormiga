<?php ?>                                                                                        
    ...
    ?>
                                                  <tr>  
                                                      ...
                                                      <td><CENTER><?=$notas->des_notas  ?></CENTER></td>
                                                      <td><CENTER><?=$notas->pes_notas  ?></CENTER></td>
...
<script type="text/javascript">
	...
	$(".btnEdicionN").click(function(){        
		...
		var ide = $(this).data("ide");                             
                ...
                $("#DIVELIMINARNOTAS").dialog({ draggable: false });
                $("#DIVELIMINARNOTAS").dialog({ resizable: false });                       
                ...
                $("#DIVEDITARNOTAS").dialog({ draggable: false });
                $("#DIVEDITARNOTAS").dialog({ resizable: false });                                 
</script>