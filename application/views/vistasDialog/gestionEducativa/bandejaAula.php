<form method="post" name="registraraula" id="registraraula">
    <div class="container">
        ...
        <label class="control-label col-md-3 col-sm-3 col-xs-12">
            <br>
            <textarea class="form-control  col-md-3" name="descripcion" id="descripcion" type="text" placeholder="Breve descripcion..."
                rows="1"></textarea>
        </label>
    </div>
    <div class="container">
        <label class="control-label col-md-3 col-sm-3 col-xs-12">
            ...
            <button type="button" id='btn_horario' name='btn_horario' class="btn btn-round btn-danger">HORARIO
                <span class="glyphicon glyphicon-list"></span>
            </button>
            <button type="button" id='btn_dias' name='btn_dias' class="btn btn-round btn-danger">DIAS
                <span class="glyphicon glyphicon-list"></span>
            </button>
        </label>
        <label class="control-label col-md-3 col-sm-3 col-xs-12">
        ...
        <label class="control-label col-md-9 col-sm-9 col-xs-12">
            Profesor:
            <input name="profesor" id="profesor" placeholder="PROFESOR" class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"
                required>
        </label>
    </div>
...
<div id="ContainerHorario" title="INTRANET EDUCATIVA :: GESTIONAR DE HORARIOS">
    <strong>Cargando...</strong>
</div>
<div id="ContainerDias" title="INTRANET EDUCATIVA :: GESTIONAR  DIAS">
    <strong>Cargando...</strong>
</div>
