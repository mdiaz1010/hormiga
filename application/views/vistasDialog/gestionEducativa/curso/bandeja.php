<?php ?>                                                                                        
    ...
    ?>
                                                  <tr>  
                                                      ...
                                                      <td><CENTER><?=$curso->des_cursos  ?></CENTER></td>
...
<script type="text/javascript">
	...
	$(".btnEdicion").click(function(){        
		...
		var ide = $(this).data("ide");                             
                ...
                $("#DIVELIMINARCURSO").dialog({ draggable: false });
                $("#DIVELIMINARCURSO").dialog({ resizable: false });                       
                ...
                $("#DIVEDITARCURSO").dialog({ draggable: false });
                $("#DIVEDITARCURSO").dialog({ resizable: false });                                 
</script>