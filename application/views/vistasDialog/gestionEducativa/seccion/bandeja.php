        ...
        <table class="table table-striped table-bordered dt-responsive nowrap  " cellspacing="0" width="100%" id="dataTables-seccion">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <CENTER>
                            <a href="javascript:" class="btnEdicion" data-id="<?=$grado->id?>">Editar</a>
                            <a href="javascript:" class="btnEliminar" data-ide="<?=$grado->id?>">Eliminar</a>
                        </CENTER>
                    </td>
                </tr>
                <?php
        ...
        buttons: {
            "SI": function () {
                $.ajax({
                    ...
                    success: function () {
                        $("#DIVSECCION").load(
                            "<?= site_url('GestionEducativa/bandejaSeccion/') ?>");
                        $("#bandejaAula").load(
