...
<table class="table table-striped table-bordered dt-responsive nowrap  " cellspacing="0" width="100%">
    ...
    ?>
        <tr>
            ...
            <td>
                <CENTER>
                    <?=$bimestre->nom_bimestre  ?>
                </CENTER>
            </td>
            <td>
                <CENTER>
                    <?=$bimestre->fecini_bimestre  ?>
                </CENTER>
            </td>
            <td>
                <CENTER>
                    <?=$bimestre->fecfin_bimestre  ?>
                </CENTER>
            </td>
            <td>
                <CENTER>
                    <a href="javascript:" class="btnEdicionB" data-id="<?=$bimestre->id?>">Editar</a>
                    <a href="javascript:" class="btnEliminarB" data-ide="<?=$bimestre->id?>">Eliminar</a>
                </CENTER>
            </td>
        </tr>
        <?php  $i++;
        ...
        buttons: {
            "SI": function () {
                ...
                $.ajax({
                    ...
                    success: function () {
                        $("#DIVBIMESTRE").load(
                            "<?= site_url('GestionEducativa/bandejaBimestre/') ?>");
