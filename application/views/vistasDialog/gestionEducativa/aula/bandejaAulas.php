...
<script type="text/javascript">
                ...
                $("#DIVEDITARAULA").dialog({ draggable: false });
                $("#DIVEDITARAULA").dialog({ resizable: false });                                    
                    ...
                    buttons: {
                        "SI": function() {        
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url:   "eliminarAulas/",
                                    data: {curso:curso,grado:grado,seccion:seccion},
                                    success: function(){                                 
                                $("#bandejaprincipal").load("<?= site_url('GestionEducativa/vistabandejaaulas/') ?>");                                                                                                                                                    
                                    }
                                    });                                            
                ...
                $("#DIVANULARAULA").dialog({ draggable: false });
                $("#DIVANULARAULA").dialog({ resizable: false });                       
