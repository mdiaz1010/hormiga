        ...
        <div class="panel-body">
            ...
            <form  method="post"  name="crearusuario" id="crearusuario">
                ...
                <label class="col-xs-6 col-md-3">
                    Nombre
                    <input name="nombre"  id="nombre" placeholder="Nombres"  class="form-control" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"               value="<?=$bodyData->results1['nombre']?>"      readonly >
                </label>
                <label class="col-xs-6 col-md-3">
                    Apellido Paterno
                ...
                <label class="col-xs-6 col-md-3">
                    Apellido Materno
                    <input name="apemat"  id="apemat" placeholder="Apellido materno"  class="form-control"  style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"     value="<?=$bodyData->results1['apemat']?>" readonly >
                </label>                
                <label class="col-xs-6 col-md-3">
                    Rol:
