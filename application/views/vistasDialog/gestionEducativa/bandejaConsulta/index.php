                          ...
                          <div class="col-sm-12">
                            ...
                            <div class="left col-xs-7">
                              ...
                              <ul class="list-unstyled">                                
                                <li><i class="fa fa-phone"></i> Telefono #: <?= $dato->telefo?></li>  
                              </ul>
                            </div>
    ...
    ?>
        ...
        ?>
                          ...
                          <div class="col-xs-12 bottom text-center">
                            ...
                            <div class="col-xs-12 col-sm-6 emphasis">
                              <button type="button" class="btn btn-primary btn-xs busqueda" data-nombre="<?=$dato->apepat.' '.$dato->apemat.' '.$dato->nombre?>">
