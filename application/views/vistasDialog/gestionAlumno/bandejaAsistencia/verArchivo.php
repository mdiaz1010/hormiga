    ...
    <div class="col-md-4">
        <div id="centrador" class="thumbnail">
            <div class="list-group right">
                <a href="javascript:" data-id="<?=$result->id?>" data-ruta="<?=$result->ruta?>" data-fec="<?=$result->fecha_jus?>" class="btn btn-danger  eliminarMaterial"
                    style='width:30px; height:30px' class="img-responsive center-block">
            ...
            <a href="<?= base_url(trim($result->ruta))?>" target="_blank" style=" outline: none;" class="img-rounded">
                ...
                <div class="caption">
                    <font style="font-style: italic;">
                        <strong>
                            <?=$result->nombre.'<br>'.$result->fec_creacion?>
                        </strong>
                    </font>
                </div>
            </a>
