    <div class="row">    
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        <table class="table table-bordered table-hover table-striped tablesorter ">
                            <thead>
                                <tr>
                                    <th><small><center></center></small></th>
                                    <th><small><center>Informe</center></small></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?=$valores['bimestre']?></td><td><?=$valores['resultado']?></td>
                                </tr>
                                <?php endforeach;?>
                            </tbody>
                        </table>
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-edit"></i>Curso: <?=$bodyData->info[0]->nombre?></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
