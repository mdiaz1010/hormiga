...
//FUNCIONES GRADO    
    ...
    public function editarAula(){
        ...
        $seccion   = $this->input->post('seccion');             $secciona=$this->Usuarios_model->busquedaSecc($seccion);
        $grado     = substr($this->input->post('grado'),0,1);   $gradosas=$this->Usuarios_model->busquedaGrado($grado);
        $curso     = $this->input->post('curso');               $cursosas=$this->Usuarios_model->busquedaCurs($curso);
...
switch ($datos[0]->user){
    ...
    default: 
        ...
        }else{echo "<h3><strong style='color:red'>Informacion Ingresada: No valida<br> Por favor ingresar correctamente los datos de la Persona</strong></h3>";die();}
